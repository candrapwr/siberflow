...
shell execution (exec), database access (db_query), and remote SSH execution (ssh_exec). All file operations are sandboxed to the project directory; ssh_exec runs remotely with NO sandbox. \
