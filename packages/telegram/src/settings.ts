...
export interface TelegramAiSettings {
  ...
  /** Image gen provider: sibergate | openai | general | deepinfra | novita | qwen | grok. */
  ...
  /** Image edit provider: sibergate | openai | general | deepinfra | novita | qwen | grok. */
...
export interface ImageGenPreset {
  ...
  name: string;
  /** Provider name: sibergate | openai | general | deepinfra | novita | qwen | grok. */
  provider: string;
