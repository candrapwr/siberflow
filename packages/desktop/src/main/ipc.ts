...
export function registerIpc(): void {
  ...
  ipcMain.handle(
    ...
    async (_e, values: SettingsValues, apiKey: string | null, multimodalApiKey: string | null, exaApiKey: string | null) => {
      host!.saveSettings(values, apiKey, multimodalApiKey, exaApiKey);
    },
  );
